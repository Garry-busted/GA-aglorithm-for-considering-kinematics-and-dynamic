function my_input = model_stright_line
...
my_input.max_joint_num=8;                                                   %% maximum joint number allowed
...
my_input.xrange=[-10,50];                                                   %% xrange of the design domain
my_input.yrange=[-10,50];                                                   %% yrange of the design domain
